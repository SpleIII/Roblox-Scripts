...
local Window = Library.CreateLib("Aaryn's Hub V2", "Sentinel")

-- Game Scripts
local Tab = Window:NewTab("Game Scripts")
local Section = Tab:NewSection("Game Scripts")
Section:NewButton("Collect All Pets! Script", "Executes Collect All Pets! Script", function()
...
Section:NewButton("Made By SpleIII", "", function()
